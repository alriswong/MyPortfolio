        ...
        <div className='flex flex-col justify-center my-10'>
            ...
            <div className='grid grid-cols-1 gap-10 md:px-15 xl:px-8'>
                ...
                className='xl:grid xl:grid-cols-12 place-items-center mx-auto'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Controller_Choosing.png"} width={800} height={600} alt='ControlGroup'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    ...
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Interaction_Circle_grip.gif"} width={800} height={600} alt='Grip'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Interaction_Circle_swing.gif"} width={800} height={600} alt='Swing'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/I_Login.png"} width={800} height={600} alt='Login'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Leaderboard.png"} width={800} height={600} alt='Leaderboard'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Single&Mutiplay.png"} width={800} height={600} alt='Single&Mutiplay'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Type_of_Training.png"} width={800} height={600} alt='Training'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Timer.png"} width={800} height={600} alt='Timer'></Image>
                ...
                className='xl:grid xl:grid-cols-12 items-center'>
                    <Image className='col-span-7 mb-5 xl:mb-0 w-full' src={"/image/project/Record_of_training.png"} width={800} height={600} alt='Record of Training'></Image>
                    <p className='col-span-4 col-start-9 text-subHeadingColor text-xl mb-5'>
