            ...
            >
                <div className={`overlay items-center justify-center top-0 left-0 w-full h-full bg-[#181818] transition-all duration-500
                    ...
                    <Link href={previewUrl} className='relative h-14 w-14 border-2 rounded-full border-[#ADB7BE] hover:border-white max-2xl:active:border-BTcolorOne group/link'>
                        <EyeIcon className='w-10 h-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer group-hover/link:text-white max-2xl:group-active/link:text-BTcolorOne'/>
