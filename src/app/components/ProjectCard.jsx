...
const ProjectCard = ({imgUrl, title, description,technologies, gitUrl, previewUrl}) => {
  return (
        <div>
            ...
            >
                <div className='overlay items-center justify-center top-0 left-0 w-full h-full bg-[#181818] hidden group-hover:flex group-hover:bg-[#181818]/80 transition-all duration-500'>
